...
namespace LiveProject
{
    public partial class EmployeeSalaryPayNew : Form
    {
        ...
        private void EmployeeSalaryPayNew_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        private void EmployeeSalaryPayNew_KeyDown(object sender, KeyEventArgs e)
        {
